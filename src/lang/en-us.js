...
var PROPERTY_GIIGYRO = 'Follow GAN gyroscope (Virtual display)';
var GIIKER_GYRO_RESET = 'Calibrate orientation';
var GIIKER_GYRO_WAIT = 'Waiting for gyro data; align cube with the display';
var F2L_GROUPS = 'Same top color|Different top colors adjacent|Different top colors separated|Cross color on top|Corner in slot|Edge in slot|Both in slot|Solved';
