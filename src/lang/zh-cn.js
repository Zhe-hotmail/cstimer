...
var PROPERTY_GIIGYRO = 'GAN姿态跟随（Virtual显示）';
var GIIKER_GYRO_RESET = '校准朝向';
var GIIKER_GYRO_WAIT = '等待姿态数据；请将魔方朝向与屏幕对齐';
var F2L_GROUPS = '顶面同色|顶面异色相邻|顶面异色分离|底色朝上|角块在槽内|棱块在槽内|角棱均在槽内|已完成';
